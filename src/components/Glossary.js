    ...
    this.state = {
      initialContent : [
        ...
        },
        {
          ...
          "description-english": "<p>Activities required to achieve a <a href=\"#/glossary?term=Goal\">Goal</a> <br />Notes:<br />1.\tMost tasks can be subdivided into subtasks \u2013that is, activities. <br />2.\tMost subtasks lead to choices or inputs of the <a href=\"#/glossary?term=User\">User</a> when using the <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>.<br />3.\tSome subtasks can be subdivided into smaller subtasks.<br />Examples of tasks: <br />1.\tRenting a car is a task. <br />2.\tCancelling a reservation is a task. <br />3.\tRegistering on a car rental website is a subtask. It is not a user <a href=\"#/glossary?term=Goal\">Goal</a> but an annoyance from the user's point of view. Users would never feel that they had achieved a goal after registering.<br />4.\t\"Logging in\" is a subtask. It is not a user goal but an annoyance from the user's point of view.<br />5.\tEntering the user name and pressing the Tab key is one of several subtasks required to complete the subtask \"logging in\". </p>",
          "description-german": "<p>Aktivit\u00e4t die erforderlich ist, um ein <a href=\"#/glossary?term=Ziel\">Ziel</a> zu erreichen.<br />Anmerkungen:<br />1.\tViele Aufgaben k\u00f6nnen in Teilaufgaben unterteilt werden.<br />2.\tViele Teilaufgaben f\u00fchren zu Auswahlm\u00f6glichkeiten oder Eingaben des Benutzers w\u00e4hrend der Nutzung des interaktiven Systems. <br />3.\tEinige Teilaufgaben k\u00f6nnen in kleinere Teilaufgaben aufgeteilt werden.<br />Beispiele f\u00fcr Aufgaben: <br />1.\t\u201eEin Auto mieten\u201c ist eine Aufgabe. <br />2.\t\u201eEine Reservierung stornieren\u201c ist eine Aufgabe. <br />3.\t\u201eSich auf der Webseite einer Autoverleihfirma registrieren\u201c ist eine Teilaufgabe. Registrierung ist vom Gesichtspunkt des Benutzers kein Ziel sondern ein \u00c4rgernis.<br />4.\t\u201eSich einloggen\u201c ist eine Teilaufgabe. Einloggen ist vom Gesichtspunkt des Benutzers kein Ziel sondern ein \u00c4rgernis.<br />5.\tDie Eingabe des Benutzernamens und das Dr\u00fccken der Tabulatortaste ist eine von vielen Teilaufgaben die erforderlich sind, um die Teilaufgabe \u201dLog-in\u201d abzuschlie\u00dfen.</p>",
          "term-english": "Task",
          "term-german": "Aufgabe"
        },
        {
        ...
        },
        {
          ...
          "description-english": "<p>A description of the subtasks that have to be carried out in order to reach the <a href=\"#/glossary?term=User\">User</a>\u2019s goals.<br />Note:<br />1.\tA <a href=\"#/glossary?term=Task\">Task</a> model describes the logic of the task itself, while a scenario describes the completion of one or more tasks by a <a href=\"#/glossary?term=Persona\">Persona</a>.</p>",
          "description-german": "<p>Eine Beschreibung der Teilaufgaben die erledigt werden m\u00fcssen, um die Ziele des Benutzers zu erreichen.<br />Anmerkung:<br />1.\tEin Aufgabenmodell beschreibt die Logik einer <a href=\"#/glossary?term=Aufgabe\">Aufgabe</a> an sich, w\u00e4hrend ein <a href=\"#/glossary?term=Szenario\">Szenario</a> die Erledigung einer oder mehrerer Aufgaben durch eine <a href=\"#/glossary?term=Persona\">Persona</a> beschreibt.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>Person who interacts with an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>, or who uses\u00a0the output of the system.<br />Notes:<br />1.\t\"User\" is subdivided into <br />a.\t<a href=\"#/glossary?term=Direct+user\">Direct user</a>: Interacts with the <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>.<br />b.\t<a href=\"#/glossary?term=Indirect+user\">Indirect user</a>: Uses the output of the <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>.<br />c.\t<a href=\"#/glossary?term=Primary+user\">Primary user</a>: Interacts with the interactive system to achieve goals supported by the interactive system.<br />d.\t<a href=\"#/glossary?term=Secondary+user\">Secondary user</a>: Interacts with the interactive system to provide support, etc.<br />2.\tStakeholders may or may not be users. Stakeholders are not considered to be users if they are affected by an interactive system but neither interact with the interactive system nor\u00a0use the output of the interactive system.<br />Examples of stakeholders who are not users:<br />1.\tManagers of users.<br />2.\tPeople affected by noise produced by the person using the interactive system.<br />3.\tMarketers affected by the impact of the\u00a0output on the brand of the interactive system.</p>",
          "description-german": "<p>Person, die mit einem interaktiven System arbeitet oder Daten die vom System erzeugt werden benutzt.<br />Anmerkungen:<br />1.\t\u201eBenutzer\u201c werden unterteilt in<br />a.\t<a href=\"#/glossary?term=Direkter+Benutzer\">Direkter Benutzer</a>: Interagiert mit dem interaktiven System.<br />b.\t<a href=\"#/glossary?term=Indirekter+Benutzer\">Indirekter Benutzer</a>: Benutzt Daten die vom interaktiven System erzeugt werden.<br />c.\t<a href=\"#/glossary?term=Prim%C3%A4rer+Benutzer\">Prim\u00e4rer Benutzer</a>: Interagiert mit dem interaktiven System um Ziele die vom interaktiven System unterst\u00fctzt werden zu erreichen.<br />d.\t<a href=\"#/glossary?term=Sekund%C3%A4rer+Benutzer\">Sekund\u00e4rer Benutzer</a>: Interagiert mit dem interaktiven System um Unterst\u00fctzung etc. zu geben.<br />2.\t<a href=\"#/glossary?term=Interessenvertreter\">Interessenvertreter</a> k\u00f6nnen Benutzer sein oder auch nicht. Sie werden nicht als Benutzer betrachtet wenn sie zwar durch das interaktive System beeinflusst werden, jedoch weder mit dem interaktiven System selbst interagieren noch das mit Hilfe des interaktiven Systems erzielte Arbeitsergebnis nutzen.<br />Beispiele von Interessenvertretern die keine Benutzer sind:<br />1.\tManager von Benutzern.<br />2.\tPersonen die von L\u00e4rm der von der Person die das interaktive System benutzt erzeugt wird betroffen sind.<br />3.\tMarketingfachleute die von der Auswirkung der Ergebnisse auf die Markenbezeichnung betroffen sind.</p>",
          "term-english": "User",
        ...
        },
        {
          ...
          "description-english": "<p>A collection of users with the same or similar personal characteristics and <a href=\"#/glossary?term=Context+of+use\">Context of use</a> related to the <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>.</p>",
          "description-german": "<p>Eine Gruppe von Benutzern mit denselben oder \u00e4hnlichen Personenmerkmalen und <a href=\"#/glossary?term=Nutzungskontext\">Nutzungskontext</a> bezogen auf das interaktive System.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>A generalized description of a <a href=\"#/glossary?term=User\">User</a> group.</p>",
          "description-german": "<p>Eine verallgemeinerte Beschreibung einer <a href=\"#/glossary?term=Benutzergruppe\">Benutzergruppe</a>.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>Person who\u00a0directly\u00a0uses\u00a0the output of the <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>, but does not interact directly with the system.<br />Example of an indirect <a href=\"#/glossary?term=User\">User</a>:\u00a0<br />1.\tA bank customer who receives a paper or electronic statement, or visits a branch is an indirect user of the output produced by the bank computer system.</p>",
          "description-german": "<p>Personen, die direkt die Ergebnisse eines interaktiven Systems nutzen, aber nicht direkt mit dem System interagieren. <br />Beispiel f\u00fcr indirekter <a href=\"#/glossary?term=Benutzer\">Benutzer</a>:<br />1.\tEin Bankkunde, der ein Dokument oder einen elektronischen Bericht erh\u00e4lt, oder eine Filiale besucht, ist ein indirekter Benutzer eines Arbeitsergebnisses, das mit Hilfe eines Systems erzeugt wurde, das die Mitarbeiter der Bank benutzen.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>Individual or organization having a right, share, claim or interest in an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a> or in its possession of characteristics that meet their needs and expectations.<br />Notes:<br />1.\tAll users are stakeholders.<br />2.\tSee also the various types of requirements.<br />3.\tThe following examples illustrate the breadth of this concept. <br />Examples of stakeholders: <br />1.\tUsers, supporters, trainers, documentation writers, developers, managers of developers, and marketing people.</p>",
          "description-german": "<p>Individuum oder Organisation, die ein Anrecht, einen Anteil, einen Anspruch oder ein Interesse auf ein <a href=\"#/glossary?term=Interaktives+System\">Interaktives System</a> oder an dessen Merkmalen hat, die ihren Erfordernissen und Erwartungen entsprechen. <br />Anmerkungen: <br />1.\tAlle <a href=\"#/glossary?term=Benutzer\">Benutzer</a> sind Interessenvertreter.<br />2.\tSiehe auch unterschiedliche Typen von Anforderungen<br />3.\tDie folgenden Beispiele f\u00fcr Interessenvertreter zeigen die breite Perspektive dieses Begriffs<br />4.\tDer englische Ausdruck f\u00fcr Interessenvertreter ist Stakeholder<br />Beispiele f\u00fcr Interessenvertreter: <br />1.\tBenutzer, Support, Trainer, Autoren von Dokumentationen, Entwickler, Manager von Entwicklern und Personen im Marketing.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>Users, tasks, <a href=\"#/glossary?term=Resources\">Resources</a>, and the physical and social environments in which an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a> is used <br />Notes:<br />1.\tThe results from observations and contextual interviews are described in the \"context of use description\". This description is the basis for identifying <a href=\"#/glossary?term=User\">User</a> needs and tracing them back to their source.<br />2.\tA context of use description describes<br />a.\tUser groups and <a href=\"#/glossary?term=User+group\">User group</a> profiles, <br />b.\tTasks, <br />c.\tEnvironments,<br />d.\tEquipment,<br />e.\tScenarios illustrating what happens in the context of use<br />Course note:<br />1.\tHelpful acronym: PACT = People, Activities, Contexts, Technologies.<br />Examples of context of use descriptions: <br />1.\tTeenagers use mobile phones to send text messages to their friends while sitting on a bus. <br />2.\tSecretaries use Microsoft Word to write documents in a firm of solicitors.</p>",
          "description-german": "<p><a href=\"#/glossary?term=Benutzer\">Benutzer</a>, Aufgaben, <a href=\"#/glossary?term=Ressourcen\">Ressourcen</a> sowie die physische und soziale <a href=\"#/glossary?term=Umgebung\">Umgebung</a> in der das interaktive System genutzt wird.<br />Anmerkungen:<br />1.\tDie Ergebnisse aus den Beobachtungen und kontextuellen Interviews werden in der \u201dNutzungskontextbeschreibung\u201d dokumentiert. Diese ist die Basis f\u00fcr das Identifizieren von Erfordernissen bzw. deren Zur\u00fcckf\u00fchrbarkeit auf den Nutzungskontext.   <br />2. Eine Nutzungskontextbeschreibung beschreibt:<br />a.\tBenutzergruppen und Benutzergruppenprofile,<br />b.\tAufgaben,<br />c.\tUmgebungen,<br />d.\tAusr\u00fcstung,<br />e.\tSzenarien, die illustrieren, was im Nutzungskontext geschieht<br />Anmerkung zum Training:<br />1.\tHilfreiche Abk\u00fcrzung: PACT = <br />People (<a href=\"#/glossary?term=Benutzer\">Benutzer</a>), <br />Activities (Aufgaben), <br />Contexts (<a href=\"#/glossary?term=Umgebung\">Umgebung</a>), <br />Technologies (Ressourcen, Ausr\u00fcstung der Benutzer)<br />Beispiele:<br />1.\tJugendliche verwenden Handys, um ihren Freunden Textmitteilungen zu senden w\u00e4hrend sie in einem Bus sitzen. <br />2.\tSekret\u00e4rinnen benutzen Microsoft Word, um Dokumente in einer Rechtskanzlei zu schreiben.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>A person who interacts with an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a> to achieve goals supported by the system.</p>",
          "description-german": "<p>Eine Person, die mit einem interaktiven System interagiert, um Ziele zu erreichen, die durch das System unterst\u00fctzt werden.</p>",
        ...
        },
        {
          ...
          "description-english": "<p>All means required to use an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>.<br />Note:<br />1.\tTypical examples of resources are time, financial cost, physical and mental effort, hardware, software and materials.</p>",
          "description-german": "<p>Alle Mittel die zur Nutzung eines interaktiven Systems notwendig sind. <br />Anmerkung: <br />1.\ttypische Beispiele von Ressourcen sind Zeit, finanzielle Kosten, physischer und mentaler Aufwand, Hardware, Software und Materialien</p>",
        ...
        },
        {
          ...
          "description-english": "<p>A person who interacts with an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a> to support\u00a0the use of the system or\u00a0maintain the system.<br />Examples of secondary users: <br />1.\tSecurity manager, administrator, trainer and maintenance.</p>",
          "description-german": "<p>Eine Person, die mit einem interaktiven System interagiert, um die Nutzung des Systems zu unterst\u00fctzen oder das System zu warten.<br />Beispiele f\u00fcr sekund\u00e4re <a href=\"#/glossary?term=Benutzer\">Benutzer</a>:<br />1.\tSicherheitsmanager, Administrator, Trainer und Wartung.</p>",
        ...
        },
        {
          ...
          "description-german": "<p>Siehe <a href=\"#/glossary?term=Szenario\">Szenario</a></p>",
          "term-english": "As-is scenario",
          "term-german": "Szenario des Ist-Zustands"
        },
        {
          "categories": [
            "Planung",
        ...
        },
        {
          ...
          "description-english": "<p>The physical, social and technical conditions in which a <a href=\"#/glossary?term=User\">User</a> interacts with an <a href=\"#/glossary?term=Interactive+system\">Interactive system</a>.<br />Note: <br />1.\tThe social conditions include the organizational conditions.</p>",
          "description-german": "<p>Die Gesamtheit der gegebenen Umst\u00e4nde oder Bedingungen, in denen ein <a href=\"#/glossary?term=Benutzer\">Benutzer</a> arbeitet. Diese umfassen die physische, soziale und technische Umgebung.<br />Anmerkung: <br />1.\tDie soziale Umgebung schlie\u00dft die organisatorische Umgebung mit ein.</p>",
